                                ...
                                <div className="p-8 space-y-6">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 pb-6 border-b border-slate-50">
                                        <div className="bg-slate-50 rounded-2xl p-4 transition-colors group-hover:bg-indigo-50/50">
                                            ...
                                            <p className="text-sm font-black text-slate-700 italic">Primary ({prop.ownershipPercentage}%)</p>
                                        </div>
                                        <div className="bg-slate-50 rounded-2xl p-4 transition-colors group-hover:bg-emerald-50/50">
                                            ...
                                            <p className="text-sm font-black text-slate-700 italic">{prop.activeTenants} Active</p>
                                        </div>
                                    </div>
                        ...
                        <div className="overflow-y-auto p-6 md:p-10 space-y-8 md:space-y-10">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    {[
                                        { label: 'Total Units', value: viewingProperty.units, desc: 'All Units' },
                                        { label: 'Occupied Units', value: Math.floor(viewingProperty.units * (viewingProperty.occupancy / 100)), desc: `${viewingProperty.occupancy}% Occupancy` },
                                        { label: 'Vacant Units', value: viewingProperty.units - Math.floor(viewingProperty.units * (viewingProperty.occupancy / 100)), desc: 'Ready for Lease' },
                                    ].map((item, idx) => (
